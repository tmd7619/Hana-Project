...
<div id="container" class="container">
    ...
    <div id="yourName">
        <table class="inputTable">
            <tr>
                ...
                <th>
                    <button class="btn btn-outline-success" onclick="chatName()" id="startBtn">확인</button>
                </th>
            </tr>
        </table>
    </div>
    <div id="yourMsg">
        <table class="inputTable">
            <tr>
                <th>메시지</th>
                <th><input style="margin-left: 10px;width: 200px;" id="chatting" placeholder="  메시지를 입력하세요."></th>
                <th>
                    <button class="btn btn-info" onclick="send()" id="sendBtn">보내기</button>
                </th>
            </tr>
        </table>
    </div>
