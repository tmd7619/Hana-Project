...
<head>
    ...
    <script>
        ...
        //     sock3 = new SockJS("https://192.168.0.15:443/chatting");
        //     socket3 = sock2;
        //     console.log(socket3)
        // })
        ...
        function sockOpen() {
            const sock3 = new SockJS("https://192.168.0.15:443/chatting/123123");
            socket3 = sock3;
            sockEvt();
        ...
        function sockEvt() {
            socket3.onopen = function (data) {
                console.log(socket3)
            }

            socket3.onmessage = function (data) {
                //메시지를 받으면 동작
                var msg = data.data;
        ...
        function send() {
            ...
            socket3.send(JSON.stringify(option))
            $('#chatting').val("");
        }
    ...
    <div class="card">
        ...
        <div>
            <input type="hidden" id="sessionId" value=""> <input
                type="hidden" id="roomNumber" value="123123">
