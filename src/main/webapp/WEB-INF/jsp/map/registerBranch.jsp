...
<body>
    ...
    <div class="map_wrap" style="margin-left: 20%;">
        <div id="map" style="width:60%;height:100%;position:relative;"></div>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c68f95dd575cfcf0f41226a101951816&libraries=services"></script>
