...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resources/admin/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
...
<%--                            <h6 class="m-0 font-weight-bold text-primary">Monthly Recap Report</h6>--%>
                                <div>
                                <iframe id="webrtc" src="https://172.20.10.2:8000/" allow="camera;microphone" style="border: 2px solid black">
                                </iframe>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-5 ">
                        <div class="card">
                            <div class="card-header py-4 bg-primary d-flex flex-row align-items-center justify-content-between">
                                ...
                                <h6 class="m-0 font-weight-bold text-light">${roomMaster} PB의 채팅 상담</h6>
                            </div>
                            <div>
                                    ...
                                    <div id="yourName">
                                        <table class="inputTable">
                                            <tr>
                                                ...
                                                <th><button class="btn btn-sm btn-primary" onclick="chatName()" id="startBtn">인증하기</button></th>
                                            </tr>
                                        </table>
                                    </div>
                                    <div id="yourMsg">
                                        <table class="inputTable">
                                            <tr>
                                                <th>메시지</th>
                                                <th><input style="margin-left: 15px" id="chatting" placeholder="  메시지를 입력하세요."></th>
